...
function MainNav(){
  ...
  return (
    <nav aria-label="Main" role="navigation" className={`${navLayout} flex flex-wrap sm:justify-between items-center mt-2 max-w-3xl mx-auto px-16px sm:px-4`}>
      ...
      <ul id={navMenuId} className={`${listDisplay} w-full xs:w-3/5 sm:w-auto flex-col sm:flex sm:flex-row sm:space-x-4 mb-4 sm:mb-2 border sm:border-0 border-solid border-gray-400 bg-gray-50 sm:bg-opacity-0 divide-y sm:divide-y-0 divid-gray-400`}>
